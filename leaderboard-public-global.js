// LIPA STUDIOS - PUBLIC GLOBAL LEADERBOARD SYSTEM
// Sistema de clasificacion global usando servicio público gratuito

class PublicGlobalLeaderboard {
...
window.PublicGlobalLeaderboard = PublicGlobalLeaderboard;
window.DailyLeaderboard = PublicGlobalLeaderboard; // Mantener compatibilidad

// Funcion helper para integrar facilmente
window.initLeaderboard = function(gameName) {
    return new PublicGlobalLeaderboard(gameName);
};

// Funcion para mostrar ranking desde cualquier parte
window.showLeaderboard = function(gameName) {
    const lb = new PublicGlobalLeaderboard(gameName);
    lb.showLeaderboard();
};

console.log('LIPA Public Global Leaderboard System loaded!');
