// LIPA STUDIOS - SIMPLE GLOBAL LEADERBOARD SYSTEM
...
window.SimpleGlobalLeaderboard = SimpleGlobalLeaderboard;
window.DailyLeaderboard = SimpleGlobalLeaderboard; // Mantener compatibilidad

// Funcion helper para integrar facilmente
window.initLeaderboard = function(gameName) {
    return new SimpleGlobalLeaderboard(gameName);
};

// Funcion para mostrar ranking desde cualquier parte
window.showLeaderboard = function(gameName) {
    const lb = new SimpleGlobalLeaderboard(gameName);
    lb.showLeaderboard();
};

console.log('LIPA Simple Global Leaderboard System loaded!');