// LIPA STUDIOS - INSTANT GLOBAL LEADERBOARD SYSTEM
// Sistema de clasificacion global usando servicio público gratuito

class InstantGlobalLeaderboard {
    constructor(gameName) {
        this.gameName = gameName;
        this.apiUrl = 'https://api.jsonbin.io/v3/b/507f1f77bcf86cd799439011'; // Bin público
        this.apiKey = '$2a$10$9v8Q8Q8Q8Q8Q8Q8Q8Q8Q8Q'; // Key pública
...
window.InstantGlobalLeaderboard = InstantGlobalLeaderboard;
window.DailyLeaderboard = InstantGlobalLeaderboard; // Mantener compatibilidad

// Funcion helper para integrar facilmente
window.initLeaderboard = function(gameName) {
    return new InstantGlobalLeaderboard(gameName);
};

// Funcion para mostrar ranking desde cualquier parte
window.showLeaderboard = function(gameName) {
    const lb = new InstantGlobalLeaderboard(gameName);
    lb.showLeaderboard();
};

console.log('LIPA Instant Global Leaderboard System loaded!');
