...
// Sistema de clasificacion global usando JSONBin (más simple que Supabase)

class SimpleGlobalLeaderboard {
    constructor(gameName) {
        this.gameName = gameName;
        this.binId = 'your-bin-id'; // Cambiar por tu JSONBin ID
        this.apiKey = 'your-api-key'; // Cambiar por tu JSONBin API Key
