// LIPA STUDIOS - FINAL GLOBAL LEADERBOARD SYSTEM
// Sistema de clasificacion global usando JSONBin público

class FinalGlobalLeaderboard {
...
window.FinalGlobalLeaderboard = FinalGlobalLeaderboard;
window.DailyLeaderboard = FinalGlobalLeaderboard; // Mantener compatibilidad

// Funcion helper para integrar facilmente
window.initLeaderboard = function(gameName) {
    return new FinalGlobalLeaderboard(gameName);
};

// Funcion para mostrar ranking desde cualquier parte
window.showLeaderboard = function(gameName) {
    const lb = new FinalGlobalLeaderboard(gameName);
    lb.showLeaderboard();
};

console.log('LIPA Final Global Leaderboard System loaded!');
