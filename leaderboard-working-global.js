// LIPA STUDIOS - WORKING GLOBAL LEADERBOARD SYSTEM
// Sistema de clasificacion global usando servicio público gratuito

class WorkingGlobalLeaderboard {
...
window.WorkingGlobalLeaderboard = WorkingGlobalLeaderboard;
window.DailyLeaderboard = WorkingGlobalLeaderboard; // Mantener compatibilidad

// Funcion helper para integrar facilmente
window.initLeaderboard = function(gameName) {
    return new WorkingGlobalLeaderboard(gameName);
};

// Funcion para mostrar ranking desde cualquier parte
window.showLeaderboard = function(gameName) {
    const lb = new WorkingGlobalLeaderboard(gameName);
    lb.showLeaderboard();
};

console.log('LIPA Working Global Leaderboard System loaded!');
